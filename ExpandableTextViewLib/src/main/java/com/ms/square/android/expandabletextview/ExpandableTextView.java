...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    /**
     * set right button text status
     */
    private void setButtonState() {
        Drawable mRightDrawable = mCollapsed ? mExpandDrawable : mCollapseDrawable;
        mButton.setCompoundDrawablesWithIntrinsicBounds(null, null, mRightDrawable, null);
        mButton.setText(mCollapsed ? R.string.string_expand : R.string.string_collapse);
    }
